...
// TODO: Use the sensor framework, rather than using the sensor directly
public class DataLoggerActivity extends Activity {
    ...
    // Timer for performing measurements
    Timer mTimer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO: Consider allowing this to fail, and maybe retrying?
        // TODO: Report failed status using a BLE profile?
        try {
    ...
    private void startAdvertising() {
        ...
        // Set device name
        BluetoothAdapter.getDefaultAdapter().setName(getResources().getString(R.string.app_name));
    ...
    private void startDataCollection() {
        ...
        mTimer.schedule(new TimerTask() {
            ...
            public void run() {
                try {
                    float temperature = mSensor.readTemperature();
                    float humidity = mSensor.readHumidity();
                    long count = DatalogDbHelper.log(mDb, temperature, humidity);
                    Log.d(TAG, String.format("Temperature: %.1f, Humidity: %.1f%%, Count: %d",
                            temperature, humidity, count));
                } catch (IOException e) {
                    // TODO: Report status to BLE profile
                    e.printStackTrace();
                }
            }
        }, 0, 10000);
